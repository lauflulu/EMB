function [t,outcome]= EMB_Diff_pLacO_Vs(a)

tic 

global  nspecies ncompartment D P A l V Vs alphamax tRNA tmat KdLacI nLacI kon koff R0
...
[t,y]=ode23s(@EMB_Diff_pLacO_Vs_function,tspan,x0,options);
...
function ydot = EMB_Diff_pLacO_Vs_function(t, y, flags)

global  nspecies ncompartment D P A l V Vs alphamax tRNA tmat KdLacI nLacI kon koff
