...
[t_100uM, y_R_100uM, r_100uM]=EMB_rand_V(mu, sigmarel, 1000, IPTG(4));
        ...
        r=r;
            ...
            [t,outcome]= EMB_2_Diff_circuit_decay_V(a, b)
...
%% Figure 1: 100 mM, plotting, topology 2

%% Figure 2: 100 mM, CV, topology 2

%% Figure 3: 10 mM, plotting, topology 2

%% Figure 4: 10 mM, CV, topology 2

%% Figure 5: 1 mM, plotting, topology 2

%% Figure 6: 1 mM, CV, topology 2

%% Figure 7: 100 uM, plotting, topology 2

%% Figure 8: 100 uM, CV, topology 2

%% Figure 9: fitting P_IPTG with the new Kd and n
