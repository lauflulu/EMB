function [t,outcome]= EMB_Diff_pLacO_A(a)

global  nspecies ncompartment D P1 P2 P A1 A2 A l V alphamax tRNA tmat KdLacI nLacI kon koff R0
...
[t,y]=ode23s(@EMB_Diff_pLacO_A_function,tspan,x0,options);
...
function ydot = EMB_Diff_pLacO_A_function(t, y, flags)
