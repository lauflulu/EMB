function [t,outcome]= EMB_Diff_Vs(a)

global  nspecies ncompartment D P A l V Vs
nspecies = 1; % IPTG
...
[t,y]=ode23s(@EMB_Diff_Vs_function,tspan,x0,options);
...
function ydot = EMB_Diff_Vs_function(t, y, flags)
